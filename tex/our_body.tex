...
\begin{figure}[H]
  \centering
  \includegraphics [width=0.9\columnwidth]{fig_score.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics [width=0.9\columnwidth]{fig_eg.jpg}
  \includegraphics [width=0.9\columnwidth]{fig_eg_AOI.jpg}
...
\begin{figure}[H]
  ...
  \caption{the heat map of the example pages in figure 3. The left is duration-weighted heat map. The right is duration-free heat map. You can see the brightness of the dots are slightly different. The two maps use Gaussian interpolation ($\sigma=30px$). Weightless means that all the kernels have the same weight.}
  \label{fig:hm}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics [width=90mm]{fig_bvae.jpg}
...
\begin{figure*}
  \centering
  \includegraphics [width=2\columnwidth]{fig_box.pdf}
...
\begin{figure*}
  \centering
  \includegraphics [width=1.75\columnwidth]{fig_out.jpg}
  \caption{the outlier page}
  \label{fig:out}
\end{figure*}
\begin{figure*}
  \centering
  \includegraphics [width=1.75\columnwidth]{fig_out_alt.jpg}
  \caption{the revised version of the outlier page}
  \label{fig:out-alt}
\end{figure*}
...
Checking the original image of the page (see figure \ref{fig:out}) on full screen, we can feel our eyes a little strained with selection pressure. So, it is seemingly not an experimental error. the rVAE really caught the unpleasant in observers' eyes.

Why this page got a fairly good score? We think it might be attributed to the beautiful contents. Objectively speaking, this is a not so bad webpage, especially the images are nice. But from designer's point of view, it still has a large room to improve. Figure \ref{fig:out-alt} is a slightly revised version of the page.
...
\begin{figure}
  \centering
  \includegraphics [width=0.9\columnwidth]{fig_vae_t.jpg}
  \includegraphics [width=0.9\columnwidth]{fig_rvae_t.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics [width=0.9\columnwidth]{fig_corr_t.jpg}
  \caption{ four curves represent VAE and rVAE (both with and without duration weights), their correlations to the aesthetic scores developing over the time line. It is clear that rVAEs keeps below the VAEs after 1000ms. It seems that the rVAEs could perform better even after the 3000ms.}
  \label{fig:corr-t}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics [width=0.9\columnwidth]{fig_vae_user_inc.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics [width=0.9\columnwidth]{fig_vae_sigma.jpg}
